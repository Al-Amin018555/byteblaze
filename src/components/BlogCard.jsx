...
const BlogCard = ({ blog, deletable, handleDelete }) => {
    ...
    return (
        <div className="relative flex">
            ...
            {deletable && (
                <div onClick={() => handleDelete(id)} className="absolute -top-5 -right-2 lg:-top-5 lg:-right-5 scale-105 p-3 rounded-full bg-primary hover:bg-secondary group cursor-pointer">
